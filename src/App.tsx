...
const TIMELINE_DATA: TimelineItem[] = [
  { id: "1", item: "Definir cenário de local", responsible: "Portal da Acústica", status: "Pendente", icon: MapPin },
  { id: "2", item: "Disponibilidade Lucas Falcão", responsible: "Portal da Acústica", status: "Pendente", icon: Users },
  ...
  { id: "6", item: "Orçamento total disponível", responsible: "Portal da Acústica", status: "Pendente", icon: Layers },
  { id: "7", item: "Aprovar proposta de escopo e dar ordem de início à agência", responsible: "Portal + Coyô", status: "Pendente", icon: CheckCircle2 },
  { id: "8", item: "Convite Digital e Impresso", responsible: "Coyô", status: "Pendente", deadline: "13 dias úteis", icon: Send },
  { id: "9", item: "Apresentação de slides para o evento", responsible: "Coyô", status: "Pendente", deadline: "4 dias úteis", icon: ImageIcon },
  { id: "10", item: "Material Técnico para/ Arquitetos", responsible: "Coyô", status: "Pendente", deadline: "4 dias úteis", icon: FileText },
  { id: "11", item: "Posts para redes sociais", responsible: "Coyô", status: "Pendente", deadline: "2 dias úteis", icon: PenTool },
  { id: "12", item: "Backdrop / painel para o local", responsible: "Coyô", status: "Pendente", deadline: "5 dias úteis", icon: Mic2 },
  { id: "13", item: "Fotografia Profissional", responsible: "Portal da Acústica", status: "Pendente", icon: ImageIcon },
  { id: "14", item: "Vídeo Teaser / Aftermovie", responsible: "Portal da Acústica", status: "Pendente", icon: Mic2 },
];
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 selection:bg-indigo-600 selection:text-white font-sans">
      ...
      <main className="p-6 md:p-12 space-y-12 max-w-[1600px] mx-auto">
        ...
        <section className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          >
            <div>
              ...
              <h2 className="text-4xl font-bold mb-6 leading-tight">Uma década <br/><span className="text-indigo-300">referência em acústica.</span></h2>
              <p className="text-indigo-100 leading-relaxed text-sm lg:text-base font-light opacity-90 max-w-md">
                Unindo celebração e geração de valor estratégico. Uma plataforma premium para arquitetos e parceiros estreitarem laços e formalizarem novos horizontes comerciais.
              </p>
            </div>
        ...
        <section className="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm">
          ...
          <div 
            ...
            className="flex gap-5 overflow-x-auto pb-6 scrollbar-hide cursor-grab active:cursor-grabbing snap-x"
          >
          ...
          <div className="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm">
            <div className="overflow-x-auto">
              <table className="w-full border-collapse text-xs mb-8">
                ...
                <tbody className="text-slate-700">
                  ...
                  <tr>
                    ...
                    <td className="p-3 text-center border border-slate-300">50</td>
                    <td className="p-3 text-center border border-slate-300 text-slate-500">R$345,00</td>
                    <td className="p-3 text-right border border-slate-300 font-bold text-slate-900 whitespace-nowrap">R$ 17.250,00</td>
                  </tr>
                  <tr>
                    ...
                    <td className="p-3 text-right border border-slate-300 font-bold text-slate-900 whitespace-nowrap">R$ 9.750,00</td>
                  </tr>
                  <tr>
                    ...
                    <td className="p-3 text-right border border-slate-300 font-bold text-slate-900 whitespace-nowrap">R$ 8.850,00</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td className="p-3 text-center border border-slate-300">50 unid</td>
                    <td className="p-3 text-center border border-slate-300 text-slate-500">R$3,00</td>
                    <td className="p-3 text-right border border-slate-300 font-bold text-slate-900 whitespace-nowrap">R$ 150,00</td>
                  </tr>
                  <tr>
                  ...
                  <tr className="bg-emerald-50/50">
                    <td colSpan={3} className="p-3 text-right font-bold border border-slate-300 text-slate-600">Subtotal</td>
                    <td className="p-3 text-right font-bold border border-slate-300 text-slate-900 whitespace-nowrap">R$ 3.730,00</td>
                  </tr>
                </tbody>
              </table>
                  ...
                  <tbody>
                    <tr className="border-b border-slate-900">
                      <td className="p-4 text-xs font-bold uppercase tracking-tight text-slate-900 border-x-[1.5px] border-slate-900">
                        ESTIMATIVA TOTAL - Cenário A (Armazém + Materiais, 50 pax)
                      </td>
                    ...
                    <tr className="border-b border-slate-900">
                      <td className="p-4 text-xs font-bold uppercase tracking-tight text-slate-900 border-x-[1.5px] border-slate-900">
                        ESTIMATIVA TOTAL - Cenário A (Coronel + Materiais, 50 pax)
                      </td>
                      <td className="p-4 text-right text-sm font-extrabold text-slate-900 border-r-[1.5px] border-slate-900 whitespace-nowrap w-40">
                        R$ 20.980,00
                      </td>
              ...
              <p className="mt-6 text-[10px] text-slate-400 font-bold uppercase tracking-widest text-center italic opacity-60">
                Os valores supra citados são estimativas preliminares sujeitas a reajustes pós-congelamento de local.
              </p>
            </div>
          </div>
        </section>
      ...
      <footer className="px-6 py-12 md:px-12 bg-white border-t border-slate-200 text-center">
        <div className="max-w-xl mx-auto space-y-8">
          <h2 className="text-2xl font-bold tracking-tight text-slate-900">Aprovar Planejamento Estratégico?</h2>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
             <button className="px-8 py-3.5 bg-indigo-600 text-white font-bold rounded-xl shadow-lg shadow-indigo-200 hover:bg-indigo-700 transition-all scale-100 active:scale-95">
                Sim, Aprovar Escopo
             </button>
             <button className="px-8 py-3.5 bg-white border border-slate-200 text-slate-700 font-bold rounded-xl hover:bg-slate-50 transition-all">
                Exportar Cronograma
             </button>
          </div>
          <p className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.4em] pt-8">
